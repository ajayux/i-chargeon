  ...
  return (
    <textarea
      ...
      className={cn(
        ...
        "border-input placeholder:text-muted-foreground focus-visible:border-base1 aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive dark:bg-input/30 flex field-sizing-content min-h-[40px]  xl:min-h-[80px] 3xl:min-h-[120px] w-full rounded-[6px] 3xl:rounded-[10px] border bg-transparent px-[15px] py-[15px] shadow-xs transition-[color,box-shadow] outline-none disabled:cursor-not-allowed disabled:opacity-50",
        className
      )}
      {...props}
    />
